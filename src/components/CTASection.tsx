    ...
    <section className="section-padding bg-primary relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-primary-foreground/15 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link to="/stores">
              <Button size="lg" variant="secondary" className="gap-2 text-base px-8 rounded-full font-semibold">
                Start Ordering
                <ArrowRight className="h-4 w-4" />
              </Button>
            </Link>
            <Link to="/signup">
              <Button size="lg" variant="outline" className="gap-2 text-base px-8 rounded-full border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10">
                Create Free Account
              </Button>
            </Link>
          </div>
