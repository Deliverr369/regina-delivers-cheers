import { BarChart3, ShoppingCart, Users, Store, Package, Megaphone, Clock, LogOut, Home, ImagePlus, Boxes, Globe, Sparkles, Search, Bell, FileText, ShieldCheck, MessageSquare } from "lucide-react";
...
const contentMenu = [
  ...
  { title: "Text Message Log", url: "/dashboard/sms-log", icon: MessageSquare },
