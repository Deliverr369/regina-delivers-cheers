...
BEGIN
  ...
  v_url := 'https://jytbfknhebutyshjzdxt.supabase.co/functions/v1/send-sms';
...
DROP TRIGGER IF EXISTS trg_send_sms ON public.notifications;
CREATE TRIGGER trg_send_sms
AFTER INSERT ON public.notifications
FOR EACH ROW EXECUTE FUNCTION public.trigger_send_sms();